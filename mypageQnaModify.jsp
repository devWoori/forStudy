...
<html>
	...
	<body>
		<div class="container myContainer">
			<div id="list_name">내가 쓴 QnA 수정하기</div>
					...
					<thead>
						<tr>
							...
							<td colspan="3" id="form_content">
								<input type="text" id="myQtitle" name="mqtitle" value="<%= mqview.getmQnaTitle() %>" maxlength="20" required />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3" id="form_content">
								<input type="text" id="popRdate" name="mqdate" value="<%= mqview.getmQnaDate() %>" readonly />
							</td>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td colspan="4" id="board_content-1">
								...
								<textarea name="mqcontent" id="popRcontent"><%= mqview.getQnaQContent() %></textarea>
							</td>
						</tr>
					</tbody>
				</table>
